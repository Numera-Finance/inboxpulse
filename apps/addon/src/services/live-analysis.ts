...
export async function classifyThreadMode(input: {
  ...
  const prompt = [
    ...
    '',
    '2. scheduling -- arranging a time IS the subject of the thread: proposing',
    '   slots, confirming availability, rescheduling, accepting or declining an',
    '   invite, adding attendees. A meeting mentioned in passing inside other',
    '   work is NOT scheduling.',
    '',
    ...
    '   Asking for something is not a complaint. A first polite follow-up is not',
    '   a complaint. Urgency alone is not a complaint.',
    '',
